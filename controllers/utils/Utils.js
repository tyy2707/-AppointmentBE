...
const sendEmail = async (email, subject, message) => {
  ...
  try {
    ...
    let info = await transporter.sendMail({
      ...
      to: email,
      subject: "PGT24h - Đăng ký tài khoản thành công",
      html: `
      <h1>Chào mừng bạn đến với PGT24H</h1>
      ...
      <p>Chúc bạn có những trải nghiệm tuyệt vời trên PGT24H!</p>
      <p>Thân ái,</p>
      <p>PGT24H Team</p>
      <p>Isn't PGT24h useful?</p>
      `,
    });
